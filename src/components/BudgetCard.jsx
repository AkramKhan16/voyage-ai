  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 bg-white rounded-3xl shadow-2xl overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-emerald-500 to-green-600 text-white p-5 sm:p-6">
        <h2 className="text-2xl sm:text-3xl font-bold">💰 Estimated Budget</h2>
      ...
      <div className="p-5 sm:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="bg-slate-50 rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="bg-slate-50 rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            ...
            <p className="text-xl sm:text-2xl font-bold text-pink-600 mt-2">
          ...
          <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-4 sm:p-6 shadow-lg text-white">
            <p className="text-4xl">💵</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mt-8 sm:mt-10">
          ...
          <div className="bg-blue-50 rounded-2xl p-5 sm:p-8 text-center shadow-sm hover:shadow-lg transition-all duration-300">
          ...
          <div className="bg-green-50 rounded-2xl p-5 sm:p-8 text-center shadow-sm hover:shadow-lg transition-all duration-300">
